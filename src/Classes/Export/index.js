export class JPEGExportStrategy {
    constructor() {
        Object.defineProperty(this, "export", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (particles, bgDrawer, colorMode, canvas) => {
                ...
                for (let i = 0; i < particles.length; i++) {
                    ...
                    ctx.arc((particle.pos.x + particle.deformityX), (particle.pos.y + particle.deformityY), particle.radius, 0, Math.PI * 2);
                    ctx.fill();
                    ctx.restore();
                }
...
export class PNGExportStrategy {
    constructor() {
        Object.defineProperty(this, "export", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (particles, _, colorMode, canvas) => {
                const exportCanvas = document.createElement('canvas');
                exportCanvas.width = canvas.width;
                exportCanvas.height = canvas.height;
                const ctx = exportCanvas.getContext('2d');
...
export class SVGExportStrategy {
    constructor() {
        Object.defineProperty(this, "export", {
            enumerable: true,
            configurable: true,
