...
export class State {
    ...
    constructor(){
        ...
        this.gui.add(this.subscribableStates, 'MAP_SCALE', 0.004, 0.05, 0.001).onChange(() => this.notify('MAP_SCALE')).name('Map Scale')
        this.gui.add(this.subscribableStates, 'MAP_STRENGTH', 1, 10, 1).onChange(() => this.notify('MAP_STRENGTH')).name('Map Strength')
