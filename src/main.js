...
document.addEventListener('DOMContentLoaded', () => {
    const uploadBTN = document.querySelector('#imagePicker');
    ...
    const datGUIStateNotifier = new DatGuiStateNotifier(stateManager, actions);
    ...
    reader.onload = function (event) {
        ...
        app.goToImageUploadedState(event.target.result, stateManager.state);
    };
    if (uploadBTN) {
